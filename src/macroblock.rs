//! VP8 macroblock mode decoding for key frames (RFC 6386 §11).
//!
//! This module wires up the structural mode-decision layer that
//! immediately follows the §19.2 frame header on a key frame:
//!
